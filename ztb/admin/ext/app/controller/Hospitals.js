Ext.define('M.controller.Hospitals', {
    ...
    init: function() {
    	this.control({
    		'hospitallist actioncolumn[id=delete]':{
           	 	click: this.deleteClick
            },
            'hospitallist button[id=add]':{
              	click: this.addClick
               },
            'hospitallist button[id=save]': {
                click: this.updateHospital
            },
            'hospitallist button[id=search]': {
    ...
    searchClick: function(o){
		...
		var grid = o.up('hospitallist');
		var store = grid.getStore();
		store.getProxy().url = "customer/list.action?idtype=search&typeid=5_"+ Ext.getCmp("keyword").getValue();
		store.load();
	 },
