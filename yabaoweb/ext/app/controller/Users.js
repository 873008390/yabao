Ext.define('M.controller.Users', {
    ...
    updateUser: function(o) {
    	...
    	Ext.Array.each(records, function(model){
    		...
    		if((model.get('saleaddress') == '' || model.get('saleaddress') == null) && model.get('salestatus') == 1){
    			isok = 0;
    			err = "省总地址不能为空";
    		}
    		if(model.get('zdy3') != '总部人员' && model.get('salestatus') == 1){
    			isok = 0;
    			err = "省总必须是总部人员";
    		}
    		if(model.get('zdy3') != '总部人员' && model.get('servicestatus') == 1){
    			isok = 0;
    			err = "客服必须是总部人员";
    		}
    		...
    		if(model.get('servicestatus') == '' || model.get('servicestatus') == null){
    			model.set('servicestatus', 0);
    		}
    		if(model.get('salestatus') == '' || model.get('salestatus') == null){
    			model.set('salestatus', 0);
    		}
