Ext.define('M.controller.Innerpublications', {
    ...
    addcontentClick: function(o, item, rowIndex, colIndex, e){
        ...
        if(store.getAt(rowIndex).get('id') == null || store.getAt(rowIndex).get('id') == ''){
        	...
        	if(store.getAt(rowIndex).get('catalogid')==194){
        		self.location = "topmanageradd.html?id="+ store.getAt(rowIndex).get('id') +"&catalogid="+ store.getAt(rowIndex).get('catalogid');
        	}else{
    ...
    addClick: function(o){
    	...
    	if(getParameter("typeid")==194){
    		self.location = "topmanageradd.html?id=0&catalogid="+ getParameter("typeid");
    	}else{
