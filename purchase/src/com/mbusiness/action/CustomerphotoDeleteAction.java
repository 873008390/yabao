...
public class CustomerphotoDeleteAction extends ActionSupport implements SessionAware{
	...
	public String delete(){
		...
		if(session.get("account") == null || session.get("account").toString() == ""){
			...
			result = customerService.deletephoto(usersession, customerphotoid);
	...
	public void setCustomerphotoid(int customerphotoid) {
