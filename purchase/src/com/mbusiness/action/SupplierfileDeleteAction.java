...
public class SupplierfileDeleteAction extends ActionSupport implements SessionAware{

	private int supplierfileid;
	...
	public String delete(){
		...
		if(session.get("account") == null || session.get("account").toString() == ""){
			...
			result = supplierService.deletefile(usersession, supplierfileid);
	...
	public int getSupplierfileid() {
		return supplierfileid;
	}

	public void setSupplierfileid(int supplierfileid) {
