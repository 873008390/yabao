...
public class AuditgroupdetailDeleteAction extends ActionSupport implements SessionAware{

	private int auditgroupdetailid;
	...
	public String delete(){
		...
		if(session.get("account") == null || session.get("account").toString() == ""){
			...
			result = auditgroupdetailService.delete(usersession, auditgroupdetailid);
	...
	public int getAuditgroupdetailid() {
		return auditgroupdetailid;
	}

	public void setAuditgroupdetailid(int auditgroupdetailid) {
		this.auditgroupdetailid = auditgroupdetailid;
	}
}
