...
public class SuppliercatalogDeleteAction extends ActionSupport implements SessionAware{
	...
	public String delete(){
		...
		if(session.get("account") == null || session.get("account").toString() == ""){
			...
			result = supplierService.deletecatalog(usersession, supplierid, catalogname);
