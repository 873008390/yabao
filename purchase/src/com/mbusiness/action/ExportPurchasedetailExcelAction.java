 ...
 *
 */
public class ExportPurchasedetailExcelAction extends ActionSupport implements SessionAware{
	...
	public String export(){
		...
		result = Export_excel.execute("purchasedetail", titles, filedNames, filedValues);
		return SUCCESS;
	}
	@Override
