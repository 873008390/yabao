...
public class PurchasesynImpl implements PurchasesynDAO {
	...
	public String syn(Usersession usersession) {
		...
		if(usersession.getUsername().equalsIgnoreCase("")){
			...
			int flag = 0;		
			if(hasPermission.hasPermission(usersession.getUsername(), "purchase", "uploaddata", session) == 0){
	...
	public class task implements Runnable{
		@Override
		public void run() {
			GetK3CloudData.queryPurchaseOrder(session);
		}
